...
using AuthGovPTSaml.Core.SAML.Services;
using System;
using System.IO;
using System.Linq;
...
namespace PortalDaCultura.AuthGov.Core.Helpers
{
    /// <summary>
    /// Modified version of the knowed class https://en.wikipedia.org/wiki/Advanced_Encryption_Standard 
    /// but uses the X509.Cert thumbprint as the key for encrypt and decrypt process
    ...
    public class StringCipher
    {
        ...
        {
            return Encrypt(plainText, CustomKey);
        }
